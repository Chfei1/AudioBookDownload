...
namespace Masuit.Tools.Net
{
    ...
    public class MultiThreadDownloader
    {
        ...
        public delegate void DProgressChanged(MultiThreadDownloader multiThread);
        /// <summary>
        /// 总下载进度更新事件
        /// </summary>
        public event DProgressChanged TotalProgressChanged;
        ...
        {
            TempFileDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "temp");
            Directory.CreateDirectory(TempFileDirectory);
        }
        ...
        void UpdateProgress()
        {
            ...
            if (TotalProgress != pr)
            {
                ...
                {
                    _aop.Post(state => TotalProgressChanged(this), null);
                }
            }
        }
        ...
        void MergeParts()
        {
            ...
            _aop.Post(state => FileDownloadFinished(this, EventArgs.Empty), null);
            //_aop.Post(state => FileMergeProgressChanged(this, 1), null);
        }
